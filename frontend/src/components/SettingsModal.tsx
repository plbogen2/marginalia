                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '8px' }}>
                    <div>
                      ...
                      <select
                        ...
                        style={{ marginTop: '4px' }}
                      >
                        <optgroup label="Google Gemini Neural Voices (30 HD Studio Voices)">
                          <option value="Fenrir">Fenrir (Deep / Authoritative Male)</option>
                          <option value="Puck">Puck (Energetic / Youthful Male)</option>
                          <option value="Charon">Charon (Gravelly / Gravitas Male)</option>
                          <option value="Aoede">Aoede (Warm / Rich / Cinematic Female)</option>
                          <option value="Kore">Kore (Soft / Introspective Female)</option>
                          <option value="Leda">Leda (Crisp / Classical Female)</option>
                          <option value="Orus">Orus (Steady / Direct Male)</option>
                          <option value="Zephyr">Zephyr (Bright / Dynamic Male)</option>
                          <option value="Callirrhoe">Callirrhoe (Expressive / Melodic Female)</option>
                          <option value="Autonoe">Autonoe (Natural / Conversational Female)</option>
                          <option value="Enceladus">Enceladus (Resonant / Bold Male)</option>
                          <option value="Iapetus">Iapetus (Warm / Baritone Male)</option>
                          <option value="Umbriel">Umbriel (Atmospheric / Quiet Male)</option>
                          <option value="Algieba">Algieba (Crisp / Articulate Male)</option>
                          <option value="Despina">Despina (Playful / Clear Female)</option>
                          <option value="Erinome">Erinome (Gentle / Lyrical Female)</option>
                          <option value="Algenib">Algenib (Punchy / Youthful Male)</option>
                          <option value="Rasalgethi">Rasalgethi (Mature / Storyteller Male)</option>
                          <option value="Laomedeia">Laomedeia (Polished / Elegant Female)</option>
                          <option value="Achernar">Achernar (Clear / Confident Male)</option>
                          <option value="Alnilam">Alnilam (Commanding / Formal Male)</option>
                          <option value="Schedar">Schedar (Warm / Velvety Female)</option>
                          <option value="Gacrux">Gacrux (Friendly / Engaging Male)</option>
                          <option value="Pulcherrima">Pulcherrima (Bright / Vivid Female)</option>
                          <option value="Achird">Achird (Mellow / Intimate Male)</option>
                          <option value="Zubenelgenubi">Zubenelgenubi (Measured / Serious Male)</option>
                          <option value="Vindemiatrix">Vindemiatrix (Lively / Animated Female)</option>
                          <option value="Sadachbia">Sadachbia (Calm / Balanced Male)</option>
                          <option value="Sadaltager">Sadaltager (Deep / Thoughtful Female)</option>
                          <option value="Sulafat">Sulafat (Rich / Dramatic Female)</option>
                        </optgroup>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <optgroup label="Google Gemini Neural Voices">
                            <option value="Puck">Puck (Energetic / Youthful Male)</option>
                            <option value="Charon">Charon (Deep / Gravitas / Cynical Male)</option>
                            <option value="Aoede">Aoede (Warm / Expressive / Cinematic Female)</option>
                            <option value="Kore">Kore (Soft / Introspective Female)</option>
                            <option value="Fenrir">Fenrir (Deep / Authoritative Male)</option>
                            <option value="Leda">Leda (Crisp / Classical Female)</option>
                            <option value="Orus">Orus (Steady / Direct Male)</option>
                            <option value="Zephyr">Zephyr (Bright / Dynamic Male)</option>
                            <option value="Callirrhoe">Callirrhoe (Melodic / Expressive Female)</option>
                            <option value="Autonoe">Autonoe (Natural Female)</option>
                            <option value="Enceladus">Enceladus (Bold Male)</option>
                            <option value="Iapetus">Iapetus (Warm Baritone Male)</option>
                            <option value="Umbriel">Umbriel (Atmospheric Male)</option>
                            <option value="Algieba">Algieba (Crisp Male)</option>
                            <option value="Despina">Despina (Playful Female)</option>
                            <option value="Erinome">Erinome (Gentle Female)</option>
                            <option value="Algenib">Algenib (Punchy Male)</option>
                            <option value="Rasalgethi">Rasalgethi (Mature Storyteller Male)</option>
                            <option value="Laomedeia">Laomedeia (Polished Female)</option>
                            <option value="Achernar">Achernar (Confident Male)</option>
                            <option value="Alnilam">Alnilam (Commanding Male)</option>
                            <option value="Schedar">Schedar (Velvety Female)</option>
                            <option value="Gacrux">Gacrux (Friendly Male)</option>
                            <option value="Pulcherrima">Pulcherrima (Bright Female)</option>
                            <option value="Achird">Achird (Mellow Male)</option>
                            <option value="Zubenelgenubi">Zubenelgenubi (Measured Male)</option>
                            <option value="Vindemiatrix">Vindemiatrix (Animated Female)</option>
                            <option value="Sadachbia">Sadachbia (Calm Male)</option>
                            <option value="Sadaltager">Sadaltager (Thoughtful Female)</option>
                            <option value="Sulafat">Sulafat (Dramatic Female)</option>
                          </optgroup>
                          <optgroup label="Microsoft Neural Voices">
                            ...
                            <option value="en-US-AriaNeural">Aria (US - Balanced / Modern)</option>
                            <option value="en-GB-RyanNeural">Ryan (UK - Atmospheric)</option>
                            <option value="en-GB-SoniaNeural">Sonia (UK - Classical)</option>
                          </optgroup>
                        </select>
                      </div>
                    )}
